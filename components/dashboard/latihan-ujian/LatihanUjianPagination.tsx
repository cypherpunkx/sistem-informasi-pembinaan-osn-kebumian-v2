...
interface LatihanUjianPaginationProps {
    total: number;
    page: number;
    limit: number;
    totalPages: number;
...
export default function LatihanUjianPagination({ total, page, totalPages }: LatihanUjianPaginationProps) {
    ...
    const setPage = (newPage: number) => {
        ...
        router.push(`/dashboard/latihan-ujian?${params.toString()}`);
    };
