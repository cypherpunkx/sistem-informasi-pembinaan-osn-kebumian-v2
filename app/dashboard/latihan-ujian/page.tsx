        ...
        <div className="space-y-8">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-text-dark/60 mt-1">Select an exam or practice session to start.</p>
                </div>
                {/* Future: Dynamic Practice Button */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {activeExams.length > 0 ? (
                            ...
                            <div className="p-5 flex-1">
                                ...
                                <div className="flex items-center gap-4 text-sm text-text-dark/60 mt-auto">
                                    ...
                                    <div className="flex items-center gap-1">
                                        ...
                                        <span>{exam.type === 'FIXED' ? 'Standard' : 'Adaptive'}</span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="col-span-full bg-white p-12 rounded-xl text-center border border-neutral-warm/20">
                        <p className="text-text-dark/50 italic">No active exams available at the moment.</p>
                    </div>
                )}
            </div>
        </div>
